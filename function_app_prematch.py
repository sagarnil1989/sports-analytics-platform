...
@app.timer_trigger(schedule="0 */15 * * * *", arg_name="timer", run_on_startup=True, use_monitor=False)
...
@app.timer_trigger(schedule="15 */60 * * * *", arg_name="timer", run_on_startup=False, use_monitor=False)
